...
int main(void){
    ...
    do{
        ...
        printf("\n\tPROVA\n");
        printf("10. Remover elemento qualquer\n11. Inserir Ordenadamente\n");
        printf("\n\tGeral\n");
        ...
        switch(opcao){
            ...
            scanf("%d", &elemento);
            getchar();
            printf("\nDeu certo a remocao?\n%d\n", removerElementoQualquer(&lista, elemento));
            break;

            case 11:
            printf("Elemento a ser inserido ordenadamente:\n");
            scanf("%d", &elemento);
            getchar();
            printf("\nDeu certo a insercao?\n%d\n", inserirOrdenadamente(&lista, elemento));
            break;
